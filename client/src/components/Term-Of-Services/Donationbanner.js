...
export default function DonationBanner() {
    ...
    return (_jsx("div", { ref: sectionRef, className: "w-full overflow-hidden flex justify-center", style: { background: "#fff" }, children: _jsx("div", { className: "w-full max-w-9xl mx-auto", children: _jsx("div", { className: "w-full py-12 sm:py-16 px-4 sm:px-6 md:px-8", children: _jsxs("div", { className: "w-full max-w-5xl mx-auto rounded-2xl px-6 sm:px-8 md:px-12 py-8 sm:py-10 flex flex-col lg:flex-row items-center gap-8 lg:gap-12", style: { background: "#322BE1" }, children: [_jsxs("div", { ref: contentRef, className: "flex-1 text-center w-full", children: [_jsxs("h2", { className: "text-white font-bold leading-tight mb-4 sm:mb-6", style: { fontSize: "clamp(1.8rem, 5vw, 2.6rem)" }, children: ["Help with Hunger by ", _jsx("br", {}), " Donating Just ", _jsxs("span", { style: { color: "var(--button-yellow)" }, children: ["US$ 8 a ", _jsx("br", {}), "month"] }), " per child"] }), _jsxs("div", { className: "flex flex-col items-center gap-4", children: [_jsxs("button", { className: "group w-full max-w-[260px] font-bold rounded-full cursor-pointer transition-all duration-300 ease-in-out bg-[var(--button-yellow)] hover:bg-[var(--dark-p2)] hover:text-white flex items-center justify-center gap-2 px-5 py-2.5", style: {
                                                color: "#000000",
