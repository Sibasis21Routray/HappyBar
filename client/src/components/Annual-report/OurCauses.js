...
export default function OurCauses() {
    ...
    return (_jsx("div", { className: "w-full min-h-screen py-16 px-4 lg:px-18", style: { background: "var(--dark-pink)" }, children: _jsxs("div", { className: "max-w-9xl mx-auto", children: [_jsx("div", { className: "flex justify-center mb-16", children: _jsxs("div", { style: { width: "fit-content", textAlign: "center" }, children: [_jsxs("h2", { ref: titleRef, className: "font-black leading-tight text-5xl md:text-6xl lg:text-7xl", style: { color: "#ffffff", }, children: ["Our", " ", _jsx("span", { style: { color: "var(--text-yellow, #D4A017)" }, children: "Causes" })] }), _jsx("div", { className: "-mt-2", style: {
                                    height: "6px",
                                    width: "100%",
                                    backgroundImage: "radial-gradient(circle, #ffffff 3px, transparent 1.5px)",
                                    backgroundSize: "10px 6px",
                                } })] }) }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 items-start", children: causes.map((cause, i) => (_jsxs("div", { className: "flex flex-col items-center text-center", style: { marginTop: cause.marginTop }, children: [_jsx("img", { src: cause.icon, alt: cause.title.join(" "), className: "mb-6 w-[145px] h-[145px] object-contain", style: {
                                    filter: "sepia(1) saturate(2) hue-rotate(290deg)"
                                } }), _jsx("div", { className: "", style: { width: "fit-content", margin: "0 auto 12px" }, children: _jsx("h3", { className: "font-bold text-lg uppercase leading-tight", style: {
                                        color: "#ffffff",
                                        textAlign: "center",
                                    }, children: cause.title.map((line, j) => (_jsx("span", { className: "", children: line }, j))) }) }), _jsx("p", { className: " text-white text-lg  text-justify", children: cause.text })] }, i))) })] }) }));
}
