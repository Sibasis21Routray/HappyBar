...
<div className="flex flex-wrap gap-6 justify-center">
  <div onClick={() => navigate("/#our-causes")}>
    <ArrowButton label="Browse Causes" filled={true} />
  </div>

  <div onClick={() => navigate("/get-involved")}>
    <ArrowButton label="Get Involved" filled={false} />
  </div>
</div>
    </div>
  );
