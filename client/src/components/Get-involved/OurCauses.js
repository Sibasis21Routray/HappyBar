...
export default function OurCauses() {
    ...
    return (_jsx("div", { className: "w-full min-h-screen py-16 lg:px-8", style: { background: "var(--dark-p3)" }, children: _jsxs("div", { className: " mx-auto p-12", children: [_jsx("div", { className: "flex justify-center mb-16", children: _jsxs("div", { style: { width: "fit-content", textAlign: "center" }, children: [_jsxs("h2", { ref: titleRef, className: "font-black leading-tight text-3xl lg:text-6xl ", style: { color: "#ffffff" }, children: ["Our", " ", _jsx("span", { style: { color: "var(--text-yellow, #D4A017)" }, children: "Causes" })] }), _jsx("div", { className: "mt-3", style: {
                                    height: "6px",
                                    width: "100%",
                                    backgroundImage: "radial-gradient(circle, #ffffff 1.5px, transparent 1.5px)",
                                    backgroundSize: "10px 6px",
                                } })] }) }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 items-start", children: causes.map((cause, i) => (_jsxs("div", { className: "flex flex-col items-center text-center", style: { marginTop: cause.marginTop }, children: [_jsx("img", { src: cause.icon, alt: cause.title.join(" "), className: "mb-6 flex-shrink-0", style: {
                                    width: 145,
                                    height: 145,
                                    objectFit: "contain",
                                    filter: "sepia(1) saturate(3) hue-rotate(290deg) brightness(1.05)"
                                } }), _jsx("div", { style: { width: "fit-content", margin: "0 auto 12px" }, children: _jsx("h3", { className: "font-bold uppercase leading-snug", style: {
                                        color: "#ffffff",
                                        fontSize: "1.rem",
                                        textAlign: "center",
                                    }, children: cause.title.map((line, j) => (_jsx("span", { className: "text-xl", children: line }, j))) }) }), _jsx("p", { className: "text-white font-medium", style: {
                                    fontSize: "1rem",
                                    lineHeight: 1.8,
                                    textAlign: "justify",
