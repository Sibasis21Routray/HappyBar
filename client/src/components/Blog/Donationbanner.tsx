...
export default function DonationBanner() {
  return (
    <div className="w-full overflow-hidden flex justify-center" style={{ background: "var(--dark-orange)" }}>
      <div className="w-full max-w-9xl mx-auto">
        <div className="w-full py-6 sm:py-8 md:py-10 px-4 sm:px-6 md:px-8">
          <div
            ...
            style={{ background: "var(--bg-orange)" }}
          >
            <div className="flex-1 text-center">
              <h2
                className="text-white font-bold leading-tight mb-4 sm:mb-5 md:mb-6"
                style={{ fontSize: "clamp(1.8rem, 5vw, 2.6rem)" }}
              >
                Your small change,<br /> their big chance!
              </h2>

              <p
                className="text-white font-semibold mb-6 sm:mb-7 md:mb-8 leading-snug"
                style={{ fontSize: "clamp(1.8rem, 4vw, 1.35rem)" }}
              >
                <span style={{ color: "#F5C518" }}>Just US$ 500 </span> to start <br />making a difference
              </p>
