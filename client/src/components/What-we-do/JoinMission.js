...
export default function JoinMission() {
    ...
    return (_jsxs("div", { className: "w-full py-16 px-6 flex flex-col items-center justify-center text-center rounded-t-2xl", style: { background: "#6e2050" }, children: [_jsx("h2", { className: "text-white font-semibold mb-12 leading-relaxed", style: {
                    ...
                    maxWidth: "1000px",
                }, children: "Join our mission. Volunteer, Donate, Advocate. Get Started Today." }), _jsxs("div", { className: "flex flex-wrap gap-6 justify-center", children: [_jsxs("div", { children: [" ", _jsx(ArrowButton, { label: "Browse Causes", filled: true })] }), _jsx("div", { onClick: () => navigate("/get-involved"), children: _jsx(ArrowButton, { label: "Get Involved", filled: false }) })] })] }));
}
