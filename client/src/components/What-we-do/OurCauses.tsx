...
export default function OurCauses() {
  ...
  return (
    <div
      className="w-full min-h-screen py-16 lg:px-18 px-4"
      style={{ background: "var(--bg-purple-dark)" }}
    >
...
/>
              ...
              {/* Card title with dotted underline that fits content */}
              <div className="flex flex-col items-center" style={{ width: "fit-content", margin: "0 auto 12px" }}>
                <h3
