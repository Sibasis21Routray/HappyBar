...
export default function OurCauses() {
    ...
    return (_jsx("div", { className: "w-full min-h-screen py-16 lg:px-18 px-4", style: { background: "var(--bg-purple-dark)" }, children: _jsxs("div", { className: "max-w-8xl mx-auto", children: [_jsx("div", { className: "flex justify-center mb-16", children: _jsxs("div", { style: { width: "fit-content", textAlign: "center" }, children: [_jsxs("h2", { ref: titleRef, className: "font-black leading-tight text-5xl md:text-6xl lg:text-7xl", style: { color: "#ffffff" }, children: ["Our", " ", _jsx("span", { style: { color: "var(--text-yellow, #D4A017)" }, children: "Causes" })] }), _jsx("div", { className: "-mt-2", style: {
                                    height: "6px",
                                    //width: "100%",
                                    backgroundImage: "radial-gradient(circle, #ffffff 3px, transparent 1.5px)",
                                    backgroundSize: "10px 6px",
                                } })] }) }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-14 items-start", children: causes.map((cause, i) => (_jsxs("div", { className: "flex flex-col items-center text-center", style: { marginTop: cause.marginTop }, children: [_jsx("img", { src: cause.icon, alt: cause.title.join(" "), className: "mb-6 flex-shrink-0", style: {
                                    width: 145,
                                    height: 145,
                                    objectFit: "contain",
                                    filter: "sepia(1) saturate(3) hue-rotate(290deg) brightness(1.05)"
                                } }), _jsx("div", { className: "flex flex-col items-center", style: { width: "fit-content", margin: "0 auto 12px" }, children: _jsx("h3", { className: "font-bold uppercase leading-snug", style: {
                                        color: "#ffffff",
                                        fontSize: "1.5rem",
                                        textAlign: "center",
                                    }, children: cause.title.map((line, j) => (_jsx("span", { className: "block", children: line }, j))) }) }), _jsx("p", { style: {
                                    fontSize: "1.2rem",
                                    color: "#e0d0d8",
                                    lineHeight: 1.8,
                                    textAlign: "justify",
                                }, children: cause.text })] }, i))) })] }) }));
}
