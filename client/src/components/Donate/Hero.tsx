    ...
    <div className="w-full overflow-hidden flex justify-center bg-white">
      <div className="w-full max-w-9xl mx-auto">
        ...
        <div 
          ...
          style={{ height: "clamp(90px, 10vw, 180px)", background: "var(--bg-orange)" }}
        />
        ...
        <div className="flex flex-col lg:flex-row items-stretch min-h-[520px] mt-[-30px] lg:mt-[-170px]">
          ...
          <div className="relative flex-shrink-0 w-full lg:w-[40%]">
            ...
            <div className="relative z-10 pl-4 sm:pl-8 md:pl-12 lg:pl-28 pr-4 sm:pr-6 md:pr-8 lg:pr-10 pt-0 pb-10">
              <img
                src={whoWeAreGirl}
                alt="Happy child"
          ...
          <div className="flex-1 flex flex-col">
            ...
            >
              <h1
                className="text-black font-bold tracking-tight text-center px-4 z-4"
                style={{
            ...
            <div className="absolute right-0 overflow-hidden w-20 sm:w-24 md:w-28 h-auto">
              <img
                src={bird}
                alt="Duck Peek"
                className="w-full h-auto animate-peek"
              />
            </div>

            {/* Body */}
            <div
              className="flex flex-col justify-start items-center text-center py-6 sm:py-10 md:py-14 px-4 sm:px-6 md:px-8 lg:px-10"
              style={{ flex: 1 }}
            >
              <p
                className="leading-loose max-w-2xl mb-4 sm:mb-6"
                style={{
              ...
              {/* Buttons */}
              <div className="flex gap-3 justify-center flex-wrap mb-6 sm:mb-8">
              ...
              <p
                className="font-bold max-w-2xl text-xs sm:text-sm md:text-base"
                style={{
                  color: "var(--link-blue)",
