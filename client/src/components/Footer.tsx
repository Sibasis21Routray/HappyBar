...
const socialLinks: SocialLink[] = [
  { icon: <InstagramIcon />, href: "https://www.instagram.com/happybarnutrition/", bg: "bg-pink-600", label: "Instagram" },
  { icon: <FacebookIcon />, href: "https://www.facebook.com/happybarnutrition/", bg: "bg-blue-700", label: "Facebook" },
  { icon: <LinkedInIcon />, href: "https://www.linkedin.com/company/happy-bar-nutrition-inc/", bg: "bg-blue-500", label: "LinkedIn" },
];

const Footer: React.FC = () => {
  return (
    <footer className="bg-black text-white w-full">
      <div className="max-w-9xl mx-auto px-8 md:px-18 py-10 sm:py-14">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12">
          ...
          <div className="flex flex-col items-center md:items-start gap-4 sm:gap-6 text-center md:text-left">
            ...
            <a
              ...
              className="text-white text-md hover:text-orange-500 transition-colors duration-200"
            >
            ...
            <div className="flex items-center justify-center md:justify-start gap-2">
              {socialLinks.map((s) => (
                <a
                  ...
                  href={s.href}
                  aria-label={s.label}
                  className={`${s.bg} text-white rounded-md w-9 h-9 flex items-center justify-center hover:opacity-80 transition-opacity`}
                  target="_blank"
          ...
          {/* Center — Address & Charity */}
          <div className="flex flex-col items-center justify-start text-center gap-3 sm:gap-4">
            <div className="text-md leading-relaxed text-white">
              <p className="font-semibold text-md">Happy Bar Nutrition Inc.</p>
              <p>1177 Burtonwood Ave,</p>
              <p>Thousand Oaks, CA 91360</p>
            </div>
            <p className="text-md text-white">
              US 501(c)(3) Registered Charity:{" "}
              <span className="font-black">1705313932903</span>
            </p>
          </div>

          {/* Right — Quick Links - Same as Navbar styling */}
          <div className="flex flex-col items-center md:items-end gap-2">
            <h4 className="font-black text-md md:text-lg mb-1 text-white">QUICK LINKS</h4>
            {quickLinks.map((link) => (
              <NavLink
                key={link.path}
                to={link.path}
                ...
                className={({ isActive }) =>
                  `text-md lg:text-lg font-bold  transition-colors duration-200 text-center md:text-right ${
        ...
        {/* Horizontal Line */}
        <div className="border-t border-neutral-800 my-8 sm:my-10"></div>

        {/* Copyright Section */}
        <div className="text-center">
          <p className="text-sm text-gray-400">
            © {new Date().getFullYear()} Happy Bar Nutrition Inc. All rights reserved.
          </p>
        </div>
